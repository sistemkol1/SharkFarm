...
namespace SharkFarm.IPC;

internal static class WebUtilities {
	internal const string BotNamesParameterDescription = "Plural argument accepting one or many bots, acts the same as [Bots] parameter in the commands - https://github.com/SharkFarmNET/SharkFarm/wiki/Commands#bots-argument";
