...
public static class SharedInfo {
	...
	internal const string AssemblyName = nameof(SharkFarm);
	internal const string DatabaseExtension = ".db";
	internal const string DebugDirectory = "debug";
	internal const string DefaultPluginTemplateGithubRepo = "SharkFarmNET/ASF-PluginTemplate";
	...
	internal const string GithubRepo = $"SharkFarmNET/{AssemblyName}";
