...
using SharkFarm.Steam.Exchange;
...
public sealed class Actions : IAsyncDisposable, IDisposable {
	...
	public async Task<bool> UnpackBoosterPacks() {
		...
		// It'd make sense here to actually check return code of ArchiWebHandler.UnpackBooster(), but it lies most of the time | https://github.com/SharkFarmDev/SharkFarm/issues/704
		bool result = true;
