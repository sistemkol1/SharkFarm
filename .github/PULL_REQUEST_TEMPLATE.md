...
- [ ] I read and understood the **[Contributing Guidelines](https://github.com/SharkFarmNET/SharkFarm/blob/main/.github/CONTRIBUTING.md)**.
- [ ] This is not a **[duplicate](https://github.com/SharkFarmNET/SharkFarm/pulls)** of an existing merge request.
- [ ] I believe this falls into the scope of the project and should be part of the built-in functionality.
- [ ] My code follows the **[code style](https://github.com/SharkFarmNET/SharkFarm/blob/main/.github/CONTRIBUTING.md#code-style)** of this project.
