...
We support **[the latest stable](https://github.com/SharkFarmNET/SharkFarm/releases/latest)** release only. In addition to that, limited support applies to **[the latest pre-release](https://github.com/SharkFarmNET/SharkFarm/releases)** version (if available). Check out our **[release cycle](https://github.com/SharkFarmNET/SharkFarm/wiki/Release-cycle)** for more info.

---

## Security advisories

We announce security advisories for our program on **[GitHub](https://github.com/SharkFarmNET/SharkFarm/security/advisories)**. Every entry includes detailed information about the security vulnerability it describes, especially affected versions, attack vectors, fixed versions as well as possible workarounds (if any).
...
If you believe that you've found one, we'd appreciate if you let us know about it. You can do so by **[opening a security advisory](https://github.com/SharkFarmNET/SharkFarm/security/advisories/new)**, where we'll do our best to evaluate your issue ASAP and keep you updated with the development status. If your vulnerability isn't crucial and doesn't result in a direct escalation, therefore can be known publicly while the appropriate fix is being implemented, you can also open a standard **[issue](https://github.com/SharkFarmNET/SharkFarm/issues/new/choose)** instead.
